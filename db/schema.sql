-- Single Source of Truth for XScore Database
-- Can be reimported safely at any time.
-- Note: For production, manually update the database name to 'db_ac41df_xscore'

-- Local Development Database
CREATE DATABASE IF NOT EXISTS XScore;
USE XScore;

-- Production Database (uncomment for production deployment)
